...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/12 15:57:46 by carys             #+#    #+#             */
/*   Updated: 2022/03/14 13:52:48 by carys            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

static void	bg_sort(t_list **stack1, t_list **stack2, t_push *push, int count)
{
	int	i;
...
static void	find_next(t_list **stack1, t_list **stack2, t_push *push)
{
...
static void	push_a(t_list **stack1, t_list **stack2, t_push *push)
{
	int	count_b;
	int	i;
...
static void	push_b(t_list **stack1, t_list **stack2, t_push *push)
{
	int	now_flag;
...
void	big_sorting(t_list **stack1, t_list **stack2, int count)
{
	...
	push.flag = 0;
	bg_sort(stack1, stack2, &push, count);
